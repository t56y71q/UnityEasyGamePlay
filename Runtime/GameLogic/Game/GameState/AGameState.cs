...
namespace EasyGamePlay
{
    ...
    {
        public bool isPlaying { get => playing; set { playing = value; FrameWork.frameWork.AddStateMachine(gameStateMachine); } }
        internal bool isUnloaded { get => unloaded; set { unloaded = value; FrameWork.frameWork.AddStateMachine(gameStateMachine); } }
